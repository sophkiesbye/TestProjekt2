...
public class DataService
{
    ...
    public void SeedData() {
        ...
        if (ordinationer[0] == null) {
            ...
            ordinationer[0] = new PN(new DateTime(2026, 1, 1), new DateTime(2026, 1, 12), 123, lm[1]);    
            ordinationer[1] = new PN(new DateTime(2026, 2, 12), new DateTime(2026, 2, 14), 3, lm[0]);    
            ordinationer[2] = new PN(new DateTime(2026, 1, 20), new DateTime(2026, 1, 25), 5, lm[2]);    
            ordinationer[3] = new PN(new DateTime(2026, 1, 1), new DateTime(2026, 1, 12), 123, lm[1]);
            ordinationer[4] = new DagligFast(new DateTime(2026, 1, 10), new DateTime(2026, 1, 12), lm[1], 2, 0, 1, 0);
            ordinationer[5] = new DagligSkæv(new DateTime(2026, 1, 23), new DateTime(2026, 1, 24), lm[2]);
    ...
    public string AnvendOrdination(int id, Dato dato) {
        ...
        if (ordination is PN pn) {
            ...
            if (success) {
                ...
                throw new ArgumentException("Dato er udenfor gyldighedsperioden for ordinationen");
            }
        }
